...
export default function CreateProject() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show pending toast
      const loadingToast = toast.loading('Creating your project... Please confirm the transaction 🚀');
      ...
      // Show mining toast
      toast.loading('Transaction confirmed! Mining in progress... ⛏️', { id: loadingToast });
      ...
      toast.error(
        error.reason || 
        error.message || 
        'Failed to create project. Please check your wallet connection and try again.'
      );
    } finally {
      setLoading(false);
    }
